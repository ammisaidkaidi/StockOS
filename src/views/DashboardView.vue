...
<template>
  <div>
    ...
    <div class="grid grid-cols-4 gap-4 mb-4">
      ...
      <div class="card p-5">
        <div style="font-size:10px;color:var(--text3);text-transform:uppercase;letter-spacing:.07em;margin-bottom:10px" class="font-mono">Clients</div>
        <div class="font-display font-bold" style="font-size:32px;color:var(--accent2)">{{ db.clients.length }}</div>
