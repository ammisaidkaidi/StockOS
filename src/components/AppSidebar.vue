...
const nav = [
  ...
  { section: 'Sales' },
  { path: '/clients',        label: 'Clients',           icon: 'users',    chip: () => db.clients.length },
  ...
  { path: '/reports/client-situation', label: 'Client Situation', icon: 'report' },
]
</script>
...
<template>
  <aside class="sidebar flex flex-col py-4 px-3 overflow-y-auto">
    ...
    <div class="mt-4 pt-4 border-t space-y-0.5" style="border-color:var(--border)">
      ...
      <div class="nav-item" @click="db.seed()"><SidebarIcon name="arrow"/><span>Seed Demo Data</span></div>
